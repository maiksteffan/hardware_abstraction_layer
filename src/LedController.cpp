...
static const LedMapping LED_MAPPINGS[LED_POSITION_COUNT] = {
    ...
    { StripId::STRIP2, 31 },  //H02 (Hold C, no sensor connected)
    { StripId::STRIP2, 23 },  //H03 (Hold B)
    { StripId::STRIP2,  3 },  //H04 (Hold A)
    { StripId::STRIP2, 59 },  //H05 (Hold E)
    // H06..H34 unused — placeholders so array size matches LED_POSITION_COUNT
    { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 },
    { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 },
    { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 },
    { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 },
    { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 },
    ...
    { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 },
    { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 },
    { StripId::STRIP2,  0 }, { StripId::STRIP2,  0 },
};
...
static const LedMirror LED_MIRRORS[] = {
    // STRIP1 is not connected — no mirrors in current hardware configuration
};
